...
public class AverageApp {
	...
	public static void main(String[] args) {
		...
		//each interaction of the loop will store the number
		for(int i = 0; i < 5; i++) {
		...
		//process
		//calculate the average of all the numbers form the array
		double avg;
		int sum = 0;
		...
		for(int i = 0; i < counter; i++) {
			sum = sum + numbers[i];// in each interaction add the current element which is stored in the [ at index to sum
		}
		//compute the avg
